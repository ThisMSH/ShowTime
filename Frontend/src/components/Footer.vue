...
<template>
    <footer>
        <div class="max-sm:px-3 md:px-20 grid sm:max-lg:grid-cols-[repeat(3,_minmax(0,_auto))] lg:grid-cols-[repeat(5,_minmax(0,_auto))] max-sm:gap-y-6 gap-2 lg:gap-0">
            <div class="flex justify-center p-5 sm:max-lg:row-start-1 sm:max-lg:row-span-2">
                <RouterLink class="" to="/">
                    <svg class="w-32 xl:w-40"
                                                            ...
                                                            <svg viewBox="0 0 192 140.58565065691295" height="140.58565065691295" width="192">
                                                                <g>
                                                                    <svg viewBox="0 0 192 140.58565065691295" height="140.58565065691295" width="192">
                                                                        ...
                                                                        <g transform="matrix(1,0,0,1,51.45120314123185,0)">
                                                                            <svg viewBox="0 0 89.0975937175363 99.3826832479883" height="99.3826832479883" width="89.0975937175363">
                                                                                <g>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0" y="0" viewBox="51 33.60000228881836 298 332.3999938964844" enable-background="new 0 0 400 400" xml:space="preserve" height="99.3826832479883" width="89.0975937175363" class="icon-icon-0" data-fill-palette-color="accent" id="icon-0">
            ...
            <div>
                <h4 class="text-xl font-semibold relative mb-5 before:absolute before:left-0 before:top-8 before:w-16 before:h-0.5 before:bg-slate-900 before:dark:bg-slate-100">Categories</h4>
                <ul class="flex flex-col gap-y-1">
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Series</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Movies</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Anime Series</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Anime Movies</RouterLink></li>
                </ul>
            </div>
            <div>
                <h4 class="text-xl font-semibold relative mb-5 before:absolute before:left-0 before:top-8 before:w-16 before:h-0.5 before:bg-slate-900 before:dark:bg-slate-100">Support & Service</h4>
                <ul class="flex flex-col gap-y-1">
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Terms of Use</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Privacy Policy</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Help/FAQ</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">License</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Contact Us</RouterLink></li>
                </ul>
            </div>
            <div>
                <h4 class="text-xl font-semibold relative mb-5 before:absolute before:left-0 before:top-8 before:w-16 before:h-0.5 before:bg-slate-900 before:dark:bg-slate-100">ShowTime</h4>
                <ul class="flex flex-col gap-y-1">
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">About</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">News</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Store</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Games</RouterLink></li>
                </ul>
            </div>
            <div>
                <h4 class="text-xl font-semibold relative mb-5 before:absolute before:left-0 before:top-8 before:w-16 before:h-0.5 before:bg-slate-900 before:dark:bg-slate-100">Account</h4>
                <ul class="flex flex-col gap-y-1">
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Create Account</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Log In</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-block transition-all hover:underline hover:underline-offset-2 hover:translate-x-2">Pricing</RouterLink></li>
                    <li><RouterLink to="" class="text-sm inline-flex gap-x-2 transition-all hover:underline hover:underline-offset-2 hover:translate-x-2 text-orange-500 dark:text-orange-400"><Icon icon="mdi:crown" class="text-xl" /> Become Premium</RouterLink></li>
                </ul>
            </div>
        </div>
        <div class="mt-5">
            <div class="flex justify-center items-center">
                <ul class="flex text-4xl md:text-6xl gap-x-5">
                    <li><a href="#" target="_blank" class="inline-block transition-all hover:text-[#FF0000] hover:-translate-y-2"><Icon icon="fa6-brands:youtube" /></a></li>
                    <li><a href="#" target="_blank" class="inline-block transition-all hover:text-[#4267B2] hover:-translate-y-2"><Icon icon="fa6-brands:square-facebook" /></a></li>
                    <li><a href="#" target="_blank" class="inline-block transition-all hover:text-[#1DA1F2] hover:-translate-y-2"><Icon icon="fa6-brands:square-twitter" /></a></li>
                    <li><a href="#" target="_blank" class="inline-block transition-all hover:text-[#833AB4] hover:-translate-y-2"><Icon icon="fa6-brands:instagram" /></a></li>
                    <li><a href="#" target="_blank" class="inline-block transition-all hover:text-[#0077b5] hover:-translate-y-2"><Icon icon="fa6-brands:linkedin" /></a></li>
                </ul>
            </div>
