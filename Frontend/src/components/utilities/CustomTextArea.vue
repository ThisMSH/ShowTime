    ...
    <div>
        <div class="relative z-0">
            <textarea v-model="inputComputed" :id="textareaID" :aria-describedby="errorID"
                ...
                class="block py-2.5 px-0 w-full max-md:text-sm bg-transparent border-0 border-b-2 appearance-none caret-orange-400 dark:caret-orange-500 focus:outline-none focus:ring-0 peer"></textarea>
