        ...
        <div class="relative max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-slate-500 dark:text-slate-400">Are you sure you want to delete <span class="font-semibold text-slate-800 dark:text-slate-200">{{ show_title }}{{ show_season ? ' - ' + show_season : '' }}</span>?</h3>
